...
const Cart = ({ setIsCartOpen }) => {
    ...
    let totalQuantity,totalNewPrice,totalOGPrice;
    if(cartDetails)
    {
         totalQuantity = cartDetails.reduce((total, item) => total + item.quantity, 0);
         totalOGPrice = cartDetails.reduce((total, item) => total + (item.quantity * item.price.mrp), 0);
         totalNewPrice = cartDetails.reduce((total, item) => total + (item.quantity * item.price.cost), 0);
    }
    else
    {
        totalQuantity=0
                                ...
                                <ProductDetails>
                                    ...
                                    <ButtonContainer>
                                        ...
                                        <Button
                                            ...
                                            color="success"
                                            sx={{ mt: 2 }}
                                            onClick={() => productBuyingHandler(data.id)}
                                        >
                                            Buy
                                        </Button>
                                    </ButtonContainer>

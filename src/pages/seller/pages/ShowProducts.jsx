...
import {deleteStuffs, deleteStuff, getProductsbySeller } from '../../../redux/userHandle';
...
const ShowProducts = () => {
  ...
  useEffect(() => {
    dispatch(getProductsbySeller(currentUser.id));
  ...
  const deleteALLHandler = (sellerID, address) => {
    dispatch(deleteStuffs(sellerID, address))
      .then(() => {
        dispatch(getProductsbySeller(currentUser.id));
      })
  }
  ...
  const deleteAllProducts = () => {
    deleteALLHandler(sellerID, "DeleteProducts")
  }
                    ...
                    {sellerProductData.map((data, index) => (
                      ...
                      >
                        <ProductContainer>
                          ...
                          <ButtonContainer>
                            <DarkRedButton
                              onClick={() => deleteHandler(data.id, "DeleteProduct")}
                            >
                              Delete
                            </DarkRedButton>
                            <BasicButton
                              onClick={() => navigate("/Seller/products/product/" + data.id)}
                            >
                              View
                            </BasicButton>
                          </ButtonContainer>

      ...
      <div id="app-container" className="app-container">
        {(!isLoggedIn && currentRole === null) && (
          <>
            ...
            <div id="routes-container" className="routes-container">
              <Routes>
        ...
        {(isLoggedIn && (currentRole === "Seller" || currentRole === "Shopsphere")) && (
          <div id="seller-dashboard-container" className="seller-dashboard-container">
            <SellerDashboard />
          </div>
        )}
      </div>
